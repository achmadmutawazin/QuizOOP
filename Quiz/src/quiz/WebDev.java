 ...
 */
public class WebDev implements Test{
    
    private double written,coding,interview,result;
    private String name;
    
    public WebDev(String name, double written, double coding, double interview){
    ...
    if (result >= 85){
        ...
        System.out.println("Congratulations to " + name + " has been accepted as Web");         
    }else {
        System.out.println("Final Score : " +result);
